...
from .common import EnumValue, Value
...
class CapacitanceAttribute(Attribute):
    def __init__(
        self, name: str, value: Union[Value, str], unit: CapacitanceUnit
    ) -> None:
...
class FrequencyAttribute(Attribute):
    def __init__(
        self, name: str, value: Union[Value, str], unit: FrequencyUnit
    ) -> None:
...
class InductanceAttribute(Attribute):
    def __init__(
        self, name: str, value: Union[Value, str], unit: InductanceUnit
    ) -> None:
...
class ResistanceAttribute(Attribute):
    def __init__(
        self, name: str, value: Union[Value, str], unit: ResistanceUnit
    ) -> None:
